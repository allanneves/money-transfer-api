...
public class TransferRecord extends UpdatableRecordImpl<TransferRecord> implements Record6<Long, Long, Long, BigDecimal, String, Timestamp> {

    private static final long serialVersionUID = 905291009;
     ...
     */
    @Override
    public Row6<Long, Long, Long, BigDecimal, String, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Long, Long, BigDecimal, String, Timestamp> valuesRow() {
     ...
     */
    @Override
    public TransferRecord values(Long value1, Long value2, Long value3, BigDecimal value4, String value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransferRecord(Long id, Long originAccount, Long destinationAccount, BigDecimal amount, String currency, Timestamp dateTime) {
        super(Transfer.TRANSFER);
